...
public class main {
    ...
    public static void main(String[] args) {
         ...
         */
        System.out.println();
        System.out.println("Die Maerchen von TES23 -- Band 1");
        System.out.println();
        ...
        System.out.println("Die Maus hat hunger und isst die Bratwurst");
        System.out.println();
         ...
         */
        System.out.println();
        System.out.println("Der Prinz und der Frosch");
        System.out.println();
        ...
        System.out.println("Eines Tages beschloss Rotkaeppchen, ihre kranke Grossmutter zu besuchen, die tief im Wald wohnte.");

        /*
         * Viertes Kapitel
         */
        System.out.println();
        System.out.println("Der verlorene Schatz");
        System.out.println();
